...
#define FIELDS_IN_NEW_CONNECTION_DEV					            5
#define SEPERATORS_IN_NEW_CONNECTION_DEV				            6 /* strlen(FIELDS_IN_NEW_CONNECTION_DEV*CONNECTION_TABLE_DEV_FIELD_SEPERATOR + CONNECTION_TABLE_DEV_ITEM_SEPERATOR) */
...
#define NEW_CONNECTION_DEV_MAX_LEN								    (CONNECTION_TABLE_DEV_MAX_SRC_IP_LEN + \
                                                                     CONNECTION_TABLE_DEV_MAX_SRC_PORT_LEN + \
                                                                     CONNECTION_TABLE_DEV_MAX_DST_IP_LEN + \
                                                                     CONNECTION_TABLE_DEV_MAX_DST_PORT_LEN + \
                                                                     CONNECTION_TABLE_DEV_MAX_PROTOCOL_LEN + \
                                                                     SEPERATORS_IN_NEW_CONNECTION_DEV)
...
// connection
typedef struct connection_row_raw_t { 
	unsigned int	    src_ip;		  	
...
typedef struct new_connection_raw_t {
