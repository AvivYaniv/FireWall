...
class PORT:
    ...
    allPorts                                                    = { HTTP:'HTTP', FTP_COMMAND:'FTP_COMMAND', FTP_DATA:'FTP_DATA', SMTP:'SMTP' }
...
class CFirewallServer(CServer):    
    ...
    def handleData(self, socketClientToFirewall, dataFromClient): 
        try:
            ...
            return
        bForwardData = self.m_dataHandler.handleData(ipSource, portSource, ipDestination, portDestination, dataFromClient)
        ...
        # Else, forwarding data to other peer
            ...
            self.onForward(socketClientToFirewall, dataFromClient)
